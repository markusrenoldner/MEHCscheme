...
struct Parameters {
    ...
    int order     = 1;
    double tol    = 1e-15;
    std::string outputfile = "out/rawdata/dirichlet-primal-cons.txt";
...
int main(int argc, char *argv[]) {
    ...
    u0.ProjectCoefficient(u_0_coeff);
    ...
    *DT_n *= -1.;
    ...
    // TODO
    mfem::Vector mass_u0 (p.Size());
    GT->Mult(u0,mass_u0);
    std::cout << mass_u0.Norml2() << "\n";
